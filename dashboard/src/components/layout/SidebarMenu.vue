<template>
  <ul class="sidebar-menu">
    ...
    <router-link tag="li" class="pageLink" to="/manage/asns/all">
      <a>
        <i class="fa fa-table"></i>
        <span class="page">ASNs</span>
      </a>
    </router-link>
    <router-link tag="li" class="pageLink" to="/manage/countries/all">
      <a>
        <i class="fa fa-table"></i>
        <span class="page">Countries</span>
      </a>
    </router-link>
